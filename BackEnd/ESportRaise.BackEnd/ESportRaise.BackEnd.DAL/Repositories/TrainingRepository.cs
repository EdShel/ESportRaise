...
namespace ESportRaise.BackEnd.DAL.Repositories
{
    public class TrainingRepository : BasicAsyncRepository<Training>
    {
        ...
        {
            using (var stopCommand = db.CreateCommand())
            {
        ...
        {
            using (var checkCommand = db.CreateCommand())
            {
            ...
            using (var getBeginCommand = db.CreateCommand())
            {
        ...
        {
            using (var getTrainingCommand = db.CreateCommand())
            {
